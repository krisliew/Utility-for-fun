...
@author: BOONPNG (Edited by KRIS LIEW)
"""
...
path_output_file3 = path_output / 'heart_result_3.csv'
path_output_file4 = path_output / 'heart_result_4.csv'
path_output_file5 = path_output / 'heart_result_5.csv'
...
logging.debug("Pausing Heart for 1 hour 1 minute before job finish")
time.sleep(3660)
